...
Graph visualization:
![alt text](netflow-01.png)

Optimization of the network flow: increase capacity of the warehouses 1, 2, 3, 4 according to the unused network capacities.

### Task 02

Task 02: extends trie with methods that count with given suffix and check if given prefix is in trie.

Available on file [task-02.py](./task-02.py)